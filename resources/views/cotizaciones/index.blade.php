      ...
      <div class="row">
        <div class="row tile_count" align="center">
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>$hoy,'f_fin'=>$hoy,'title'=>'diarias','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">{{$hoy->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Esta semana</span>
            <div class="count" align="center">{{$esta_sema}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>$inicio_sem,'f_fin'=>$hoy,'title'=>'semanal','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$inicio_sem->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Ultimos <i class="red">15 </i>dias</span>
            <div class="count "  align="center">{{$ult_15d}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>$ult_15,'f_fin'=>$hoy,'title'=>'ult_15_dias','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$ult_15->format('d/m/Y')}}  </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Este mes</span>
            <div class="count" align="center">{{$este_mes}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>$inicio_mes,'f_fin'=>$hoy,'title'=>'mes','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$inicio_mes->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
          ...
          <div class="table-responsive">
            <table class="table table-striped jambo_table bulk_action">
              ...
              <tbody>
                ...
                <tr class='v_link' 
                @if($title == 'index')
                data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'mes','mes'=>$mes-> MES,'regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}" @endif
                @if($title == 'regional')
                data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional_mes','mes'=>$mes-> MES,'regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}" @endif
                @if($title == 'marca')
        ...
        <div class="table-responsive">
          <table class="table table-striped jambo_table bulk_action">
            ...
            <tbody>
              ...
              @if( $title == 'mes_regional' || $title == 'regional_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$dia-> FECHA_COTIZACION,'f_fin'=>$dia-> FECHA_COTIZACION,'mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}"  
              @endif
              
              @if( $title == 'semanal' )
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$dia-> FECHA_COTIZACION,'f_fin'=>$dia-> FECHA_COTIZACION,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}"  
              @endif
              
              @if( $title == 'mes_marca' || $title == 'marca_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$dia-> FECHA_COTIZACION,'f_fin'=>$dia-> FECHA_COTIZACION,'mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}"  
              @endif
      ...
      <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
          ...
          <tbody>
            ...
            @if($title == 'index')
            data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional','mes'=>'0','regional'=>$reg-> REGIONAL,'marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}"@endif
            ...
            data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'marca_regional','mes'=>'0','regional'=>$reg-> REGIONAL,'marca'=>$marca,'sucursal'=>'0','modelo'=>'0'])}}" @endif  
             ...
             @if( $title == 'mes_marca' || $title == 'marca_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>$reg-> REGIONAL,'marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}"  
              @endif
    ...
    <div class="table-responsive">
      <table class="table table-striped jambo_table bulk_action">
        ...
        <tbody>
          ...
          @if($title == 'regional')
          data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional_sucursal','mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=> $suc-> SUCURSAL,'modelo'=>'0'])}}" 
          @endif
          
          @if( $title == 'mes_regional' || $title == 'regional_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>$suc-> SUCURSAL,'modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}"  
              @endif
  ...
  <div class="table-responsive">
    <table class="table table-striped jambo_table bulk_action">
      ...
      <tbody>
        ...
        @if($title == 'index')
        data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'marca','mes'=>'0','regional'=>'0','marca'=>rtrim(($mar-> MARCA)),'sucursal'=>'0','modelo'=>'0'])}}" @endif

        @if($title == 'mes')
        data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'mes_marca','mes'=>$mes,'regional'=>'0','marca'=>$mar-> MARCA,'sucursal'=>'0','modelo'=>'0'])}}" @endif
        ...
        @if($title == 'diarias' || $title == 'semanal'|| $title == 'ult_15_dias' )
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>$mar-> MARCA,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}" @endif

        @if($title == 'mes_regional')
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>$regional,'marca'=>$mar-> MARCA,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}" @endif
    ...
    <table class="table table-striped jambo_table bulk_action">
      ...
      <tbody>
        ...
        data-href="{{route('cotizaciones.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'marca_modelo','mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>str_replace("/", "_", $mod-> MODELO)])}}" @endif
         ...
         @if( $title == 'mes_marca' || $title == 'marca_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>str_replace("/", "_", $mod-> MODELO),'master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0'])}}" @endif              
...
<div @if($title == 'diarias') class="col-md-4 col-sm-12 col-xs-12 animated fadeIn" @else class="col-md-3 col-sm-12 col-xs-12 animated fadeIn" @endif>
  <div class="x_panel">
    <h2>VENDEDORES<small><button class="show-all">ver todos</button></small></h2>
  </div>
  <div class="table-responsive">
    <table class="table table-striped jambo_table bulk_action">
      <thead>
      ...
      <tbody>
        ...
        @if($title == 'index')
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>$ven-> VENDEDOR,'nro_cotizacion'=>'0'])}}" @endif

        @if($title == 'diarias' || $title == 'semanal' || $title == 'ult_15_dias' )
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>$ven-> VENDEDOR,'nro_cotizacion'=>'0'])}}" @endif

        @if($title == 'mes')
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>$ven-> VENDEDOR,'nro_cotizacion'=>'0'])}}" @endif

        @if($title == 'mes_regional')
        data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>$ven-> VENDEDOR,'nro_cotizacion'=>'0'])}}" @endif

        @if( $title == 'mes_marca' || $title == 'marca_mes')
              data-href="{{ route('cotizaciones.lista_detalle',['v_aux'=>$v_aux,'title'=>'0','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>$ven-> VENDEDOR,'nro_cotizacion'=>'0'])}}" @endif 
