  ...
  <div class="right_col" role="main">
    <div class="">
      <div class="page-title">
        <div class="title">
          <h3>
            <a href="{{route('ventas.index')}}">REPORTE DE VENTAS / </a> <a href="{{route('ventas.por_mes',$mes)}}">{{$desc_mes}}-{{$año_actual}} / </a>  <a href="{{route('ventas.mes_regional',['reg'=>$reg,'mes'=>$mes])}}">{{$reg}}/ </a>
            <small><i class="red"> {{$suc}} </i> <i class="fa fa-pencil-square-o"></i></small>
          </h3>
        </div>
      ...
      <div class="row">
        <div class="col-md-offset-8">
          <div class="">
            <label>
              <input type="checkbox" class="js-switch v_res" @if($vista =='1') checked @endif data-href="{{route('ventas.detalle_mes_regional_sucursal',['mes'=>$mes,'suc'=>$suc, 'reg'=>$reg,'vista'=>'1'])}}" /> Datos Genrales
            </label>
         &nbsp|&nbsp
            <label>
               <input type="checkbox" class="js-switch v_res" @if($vista =='0') checked @endif data-href="{{route('ventas.detalle_mes_regional_sucursal',['mes'=>$mes,'suc'=>$suc, 'reg'=>$reg,'vista'=>'0'])}}" /> Datos Completos
            </label>
          </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>VENTAS <small> {{$desc_mes}}-{{$año_actual}}-{{$reg}} -{{$suc}} </small></h2>
