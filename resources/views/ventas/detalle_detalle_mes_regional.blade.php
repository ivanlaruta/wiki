    ...
    <div class="">
      ...
      <div class="row">
        <div class="col-md-offset-8">
          <div class="">
            <label>
              <input type="checkbox" class="js-switch v_res" @if($vista =='1') checked @endif data-href="{{route('ventas.detalle_detalle_mes_regional',['mes'=>$mes,'reg'=>$reg,'vista'=>'1','origen'=>'regional_mes'])}}" /> Datos Genrales
            </label>
         &nbsp|&nbsp
            <label>
               <input type="checkbox" class="js-switch v_res" @if($vista =='0') checked @endif data-href="{{route('ventas.detalle_detalle_mes_regional',['mes'=>$mes,'reg'=>$reg,'vista'=>'0','origen'=>'regional_mes'])}}" /> Datos Completos
            </label>
          </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>VENTAS <small> {{$desc_mes}}-{{$año_actual}}-{{$reg}}  </small></h2>
