...
<div class="modal-header">
  ...
  <h4 class="modal-title">Nueva Parametrica</h4>
</div>
<div class="modal-body">
            ...
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">TABLA 
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="TABLA" name="TABLA" required="required" class="form-control col-md-7 col-xs-12" >
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">CAMPO 
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="CAMPO" name="CAMPO" required="required" class="form-control col-md-7 col-xs-12" >
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">VALOR 
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
