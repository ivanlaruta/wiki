  ...
  <div class="right_col" role="main">
          ...
          <div class="page-title">
              <div class="title_left">
                <h3>SOLICITUDES / <small>Lista de Solicitudes</small></h3>
              </div>

              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="pull-right">
                      <a href="{{ route('solicitudes.create')}}" class="btn btn-success btn-round " data-toggle="tooltip" data-placement="bottom" title="Agregar" ><i class="fa fa-plus"></i> Crear nueva solicitud</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        @foreach($env as $envs)
                        <tr class='clickable-row' data-href="{{ route('solicitudes.detalle',$envs-> id_solicitud )}}" >                
                          <td>{{ $envs-> id_solicitud }}</td>
                          <td>{{ $envs -> origen }}</td>
                          <td>{{ $envs -> destino }}</td>
                          <td>{{ $envs -> tipo}}</td>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr class='clickable-row' data-href="{{ route('solicitudes.detalle',$envs1-> id_solicitud )}}" >                
                          <td>{{ $envs1-> id_solicitud }}</td>
                          <td>{{ $envs1 -> origen }}</td>
                          <td>{{ $envs1 -> destino }}</td>
                          <td>{{ $envs1 -> tipo}}</td>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                      ...
                      <tbody>
                        ...
                        <tr @if($envs2 -> estado == '3') class="clickable-row danger" @endif
                            ...
                            id="clickable-row" data-href="{{ route('solicitudes.detalle',$envs2-> id_solicitud )}}" >    
