                  ...
                  <div >
                    ...
                    <!-- Smart Wizard -->
                      ...
                      <div ">
                          ...
                          {!! Form::open (['route' => 'solicitudes.store','method' => 'POST','class' => 'form-horizontal form-label-left'])!!}
                      
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">FECHA</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                      
                            <input type="text" name="fecha" value="<?php date_default_timezone_set('America/La_Paz');  $time = time();echo date("Y-m-d", $time);?> " readonly class='form-control'>
                            </div>
                          </div>
