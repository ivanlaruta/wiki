...
<div class="right_col" role="main">
  ...
  <div class="page-title">
    <div class="col-md-11">
      <h3>
        <a href="{{ route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'index','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">RESERVAS {{$año_actual}} </a>  

        @if( $title == 'mes_regional' || $title == 'mes' || $title == 'diarias' || $title == 'mes_marca')
        <a href="{{ route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'mes','mes'=>$mes,'regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}"> / {{$desc_mes}} </a>  
        @endif 
        ...
        <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'marca','mes'=>'0','regional'=>'0','marca'=>($marca),'sucursal'=>'0','modelo'=>'0'])}}"> 
          / {{$marca}}  </a>
          @endif 
          ...
          <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional','mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}"> / {{$regional}} </a>  
          @endif 
      ...
      <div class=" col-md-1 pull-right" >
         <a href="{{route('reservados.busqueda')}}" class="btn btn-success btn-sm btn-round" >
      ...
      <div class="row">
        <div class="row tile_count" align="center">
          ...
          <span class="count_top"><i class="fa fa-clock-o"></i> Hoy, {{$v_aux}} </span>
            ...
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>$hoy,'f_fin'=>$hoy,'title'=>'diarias','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">{{$hoy->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Esta semana</span>
            <div class="count" align="center">{{$esta_sema}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>$inicio_sem,'f_fin'=>$hoy,'title'=>'semanal','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$inicio_sem->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Ultimos <i class="red">15 </i>dias</span>
            <div class="count "  align="center">{{$ult_15d}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>$ult_15,'f_fin'=>$hoy,'title'=>'ult_15_dias','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$ult_15->format('d/m/Y')}}  </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Este mes</span>
            <div class="count" align="center">{{$este_mes}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>$inicio_mes,'f_fin'=>$hoy,'title'=>'mes','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$inicio_mes->format('d/m/Y')}} </a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> Este año</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'index','mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}">Desde el {{$inicio_año->format('d/m/Y')}}</a></span>
          </div>
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_diarias','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">Total dia</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_semanal','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">Total {{$title}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{date('d/m/Y',strtotime($inicio))}} -{{date('d/m/Y',strtotime($final))}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_ult_15_dias','f_ini'=>$inicio,'f_fin'=>$final,'mes'=>'0','regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">Total {{$title}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_mes','f_ini'=>'0','f_fin'=>'0','mes'=>$mes,'regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">Total {{$desc_mes}}</a></span>
          </div>
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_regional','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">Total {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$regional}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_regional_sucursal','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=>$sucursal,'modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}"> {{$sucursal}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$regional}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_mes_regional','f_ini'=>'0','f_fin'=>'0','mes'=>$mes,'regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$desc_mes}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$regional}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_regional_mes','f_ini'=>'0','f_fin'=>'0','mes'=>$mes,'regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$desc_mes}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            ...
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_marca','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$marca}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$marca}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_mes_marca','f_ini'=>'0','f_fin'=>'0','mes'=>$mes,'regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$desc_mes}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$marca}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_marca_mes','f_ini'=>'0','f_fin'=>'0','mes'=>$mes,'regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$desc_mes}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$marca}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_marca_modelo','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>'0','marca'=>$marca,'sucursal'=>'0','modelo'=>$modelo,'master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$modelo}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$marca}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_regional_marca','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>$regional,'marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$marca}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="col-md-2 col-sm-6 col-xs-6 tile_stats_count animated flipInY">
            <span class="count_top"><i class="fa fa-clock-o"></i> {{$marca}}</span>
            <div class="count blue" align="center">{{$total}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-calendar"></i> </i> <a href="{{ route('reservados.lista_detalle',['v_aux'=>$v_aux,'title'=>'det_marca_regional','f_ini'=>'0','f_fin'=>'0','mes'=>'0','regional'=>$regional,'marca'=>$marca,'sucursal'=>'0','modelo'=>'0','master'=>'0','chassis'=>'0','vendedor'=>'0','nro_cotizacion'=>'0','cliente'=>'0'])}}">{{$marca}} {{$año_actual}}</a></span>
          </div>
          @endif
          ...
          <div class="table-responsive">
            <table class="table table-striped jambo_table bulk_action">
              <thead>
                <tr>
                  <th>MES</th>
                  <th style="text-align: center;"><small>RESERVAS</small></th>
                </tr>
              </thead>
              <tbody>
                ...
                @if($title == 'index')
                data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'mes','mes'=>$mes-> MES,'regional'=>'0','marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}" @endif

                @if($title == 'regional')
                data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional_mes','mes'=>$mes-> MES,'regional'=>$regional,'marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}" @endif
                ...
                <td align="center"><span class="badge badge-success">{{ $mes-> RESERVADOS }}</span></td>
              </tr>
              @endforeach
            </tbody>
          </table>
      ...
      <div class="table-responsive">
        <table class="table table-striped jambo_table bulk_action">
          ...
          <tbody>
            ...
            @if($title == 'index')
            data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional','mes'=>'0','regional'=>$reg-> REGIONAL,'marca'=>'0','sucursal'=>'0','modelo'=>'0'])}}"@endif
            ...
            <td align="center"><span class="badge badge-success">{{ $reg-> RESERVADOS }}</span></td>
          </tr>
          @endforeach
        </tbody>
      </table>
    ...
    <div class="table-responsive">
      <table class="table table-striped jambo_table bulk_action">
        ...
        <tbody>
          ...
          @if($title == 'regional')
          data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'regional_sucursal','mes'=>'0','regional'=>$regional,'marca'=>'0','sucursal'=> $suc-> SUCURSAL,'modelo'=>'0'])}}" 
          @endif
          ...
          >                
          <td> {{ $suc-> SUCURSAL }}</td>
          <td align="center"><span class="badge badge-success">{{ $suc-> RESERVADOS }}</span></td>
        </tr>
        @endforeach
      </tbody>
    </table>
  ...
  <div class="table-responsive">
    <table class="table table-striped jambo_table bulk_action">
      ...
      <tbody>
        ...
        @if($title == 'index')
        data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'marca','mes'=>'0','regional'=>'0','marca'=>rtrim(($mar-> MARCA)),'sucursal'=>'0','modelo'=>'0'])}}" @endif

        @if($title == 'mes')
        data-href="{{route('reservados.dashboard',['v_aux'=>$v_aux,'f_ini'=>'0','f_fin'=>'0','title'=>'mes_marca','mes'=>$mes,'regional'=>'0','marca'=>$mar-> MARCA,'sucursal'=>'0','modelo'=>'0'])}}" @endif
        ...
        >                
        <td> {{ $mar-> MARCA }}</td>
        <td align="center"><span class="badge badge-success">{{ $mar-> RESERVADOS }}</span></td>
      </tr>
      @endforeach
    </tbody>
  </table>
  ...
  <div class="table-responsive">
    <table class="table table-striped jambo_table bulk_action">
      ...
      <tbody>
        ...
        >                
        <td> {{ $mod-> MODELO }}</td>
        <td align="center"><span class="badge badge-success">{{ $mod-> RESERVADOS }}</span></td>
      </tr>
      @endforeach
    </tbody>
  </table>
  ...
  <div class="table-responsive">
    <table class="table table-striped jambo_table bulk_action">
      ...
      <tbody>
        ...
        <td align="center"><span class="badge badge-success">{{ $ven-> RESERVADOS }}</span></td>
      </tr>
      @endforeach
    </tbody>
  </table>
